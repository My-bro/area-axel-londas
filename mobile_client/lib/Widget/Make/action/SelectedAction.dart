...
class SelectedAction extends StatefulWidget {
  ...
  @override
  _SelectedActionState createState() => _SelectedActionState();
}

class _SelectedActionState extends State<SelectedAction> {
  Color get serviceColor =>
      HexColor.fromHex(widget.selectedactionService.color);
  ...
  Future<String> fetchSvgUrl() async {
    ...
    final service_id = widget.selectedactionService.id;
    final response =
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Deletebutton(onPressed: _deleteAction, serviceColor: serviceColor),
          TitleText(title: widget.selectedAction.first.title),
          SvgFutureBuilder(svgUrl: _svgUrl),
          DescriptionText(description: widget.selectedAction.first.description),
          ProviderText(provider: widget.selectedAction.first.provider),
        ],
      ),
    );
  }
